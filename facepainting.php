                  ...
                  <div class="card-body py-5">
                    <h6 class="text-primary text-uppercase"><b>Face painting</b></h6></h6><br>
                                 <p> <span style="font-weight: 900;"> Event code:</span> <span style="font-weight: 600;"></span>
                                   <br>
                                   <span style="font-weight: 900;"> Event name:</span> <span style="font-weight: 600;"> ArtPhoria </span><br><br>
                                   ...
                                   <span class="font-weight-900">Staff Coordinator 1:</span>&nbsp;&nbsp;<span class="font-weight-600"> Dr.Raghavendra( Chemistry dept)<br>
                                      <span class="font-weight-900">Staff Coordinator 2:</span>&nbsp;&nbsp;<span class="font-weight-600"> Dr.Supriya Kulkarni( Civil dept)<br>
                                          <span class="font-weight-900">Staff Coordinator 3:</span>&nbsp;&nbsp;<span class="font-weight-600"> Prof.zuhi( EC dept)<br>
     <br> <span class="font-weight-900">Student Coordinator 1:</span>&nbsp;&nbsp;<span class="font-weight-600"> Abhishek Chalke &nbsp;&nbsp;[ 9743744284 ]
    </span>&nbsp; &nbsp; <br><b>
<span class="font-weight-900">Student Coordinator 2:</span>&nbsp;&nbsp; <span class="font-weight-600">Rutuja Kelkar&nbsp;&nbsp;[ 7204345706 ]</span> &nbsp; &nbsp;<br> <br>
      ...
      <span style="font-weight: 900;"> No. of participants / Team size (with conditions):</span> <span style="font-weight: 900;"> Team event (2 people - the one who wil paint and the other whose face will be painted ). </span> <br>
      ...
      <span style="font-weight: 900;"> No. of rounds: </span> <span style="font-weight: 900;"> 2 </span> <br>
                          </p><br>
                          <h1>Details of event :</h1><br>
                         <h3> Round one : Face Xpresso</h3> 
<h4>Rules :-</h4>
1. Team event (2 people - the one who wil paint and the other whose face will be painted ).<br>
...
<h4>Rules :-</h4>
1.Select a spot in the campus and capture it in your mobile/tablet etc within 15 minutes.<br>
